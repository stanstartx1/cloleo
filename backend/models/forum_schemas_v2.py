"""
Updated forum schemas for threaded comments
"""
...
class ForumCommentCreate(BaseModel):
    ...
    mentions: Optional[List[str]] = []  # List of mentioned user IDs
...
class ForumVoteCreate(BaseModel):
    vote_type: str = Field(..., pattern="^(up|down)$")  # upvote or downvote


class ForumBestAnswer(BaseModel):
    comment_id: str = Field(..., description="ID of the comment to mark as best answer")
